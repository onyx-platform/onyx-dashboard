...
A dashboard for the [Onyx](https://github.com/MichaelDrogalis/onyx) distributed computation system, version 0.7.3.
...
compatible with Onyx 0.7.3, use a version fo the dashboard beginning with
0.7.3. The fourth version number will be reserved for dashboard versioning, in
