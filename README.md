...
A dashboard for the [Onyx](https://github.com/onyx-platform/onyx) distributed computation system, version 0.7.5-SNAPSHOT.
...
compatible with Onyx 0.7.5-SNAPSHOT, use a version of the dashboard beginning with
